...
"""
    ...
    entry_subject.insert(INSERT, f"Fwd:{subject}")
    ...
    def event_pressed_send():
        recvers = entry_to.get()
        for receiver in recvers.split(", "):
            forward_mail_func(
                username,
                password,
                receiver,
...
# display_forward_mail("18520165@gm.uit.edu.vn", "1634608674")


def forward_mail_func(
    username,
    password,
    receiver_email="",
    Subject="",
